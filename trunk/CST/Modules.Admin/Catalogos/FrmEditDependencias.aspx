<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmEditDependencias.aspx.cs" Inherits="Modules.Admin.Catalogos.FrmEditDependencias" %>
            ...
            <td>     
				    <table id="userdetails" width="100%">
					    ...
					    <tr>
						    ...
						    <th style="text-align:left; vertical-align:top">Id Dependencia</th>
						    <td align="left" class="Line">
                            <asp:textbox id="txtIdDependencia" MaxLength="10" runat="server"></asp:textbox>
                            
                             <asp:requiredfieldvalidator id="rfvIdDependencia" 
						        runat="server" 
						        errormessage="El campo [Id Dependencia] es requerido!!." 
						        cssclass="validator"
								display="Dynamic" 
								enableclientscript="true" 
								controltovalidate="txtIdDependencia">
