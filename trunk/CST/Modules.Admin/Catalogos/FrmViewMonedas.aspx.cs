...
{
    public partial class FrmViewMonedas : ViewPage<FrmViewMonedasPesenter, IFrmMonedasView>, IFrmMonedasView
    {
        public event EventHandler FilterEvent;

        protected void Page_Load(object sender, EventArgs e)
        {
            ImprimirTituloVentana("Administración Monedas");
        }
        ...
        public void GetMonedas(List<Monedas> items)
        {
        ...
        {
            var rol = e.Item.DataItem as Monedas;
            ...
            if (cmdEditar != null)
            {
                cmdEditar.CommandArgument = rol.IdMoneda;
            }
        ...
        {
            Response.Redirect(string.Format("FrmEditMonedas.aspx{0}&TemplateId={1}", GetBaseQueryString(), e.CommandArgument));
        }

        protected void BtnNewClick(object sender, EventArgs e)
        {
            Response.Redirect(string.Format("FrmEditMonedas.aspx{0}", GetBaseQueryString()));
        }
    }
}