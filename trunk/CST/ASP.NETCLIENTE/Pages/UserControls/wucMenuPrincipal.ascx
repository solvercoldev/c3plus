<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucMenuPrincipal.ascx.cs" Inherits="ASP.NETCLIENTE.Pages.UserControls.WucMenuPrincipal" %>  
 ...
 <asp:Panel ID="pnPageMenu" runat="server" Height="20px" Width="100%" HorizontalAlign="Left" BackColor="#CBCBCB" BorderStyle="None" BorderWidth="0px">
  <asp:Menu ID="mnuMenuPrincipal" runat="server" Font-Bold="False"  Orientation="Horizontal"
            ...
            <StaticMenuItemStyle ForeColor="#585858"  BorderStyle="None" Font-Size="12px" Font-Bold="true" 
                ItemSpacing="5px" Width="100" VerticalPadding="1px" CssClass="TextMenuStatic"
                Height="20px" />
            ...
            <DynamicSelectedStyle BackColor="#C2C2C2" BorderStyle="None" Font-Bold="True" ForeColor="White"
                Height="19px" />
            <DynamicMenuItemStyle BackColor="#D8D8D8" ForeColor="#585858" Width="200px" VerticalPadding="0px"
