...
namespace Domain.MainModules.Entities
{
    ...
    public partial class Terceros: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string IdTercero
        {
            ...
            set
            {
                if (_idTercero != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'IdTercero' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _idTercero = value;
        ...
        private void FixupPagosObligaciones(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Terceros, this))
                    {
                        item.Terceros = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
