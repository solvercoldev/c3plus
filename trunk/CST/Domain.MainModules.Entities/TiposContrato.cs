...
namespace Domain.MainModules.Entities
{
    ...
    public partial class TiposContrato: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string IdTipoContrato
        {
            ...
            set
            {
                if (_idTipoContrato != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'IdTipoContrato' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupTBL_Admin_Usuarios(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TiposContrato.Contains(this))
            {
                previousValue.TiposContrato.Remove(this);
            }
    
            if (TBL_Admin_Usuarios != null)
            {
                if (!TBL_Admin_Usuarios.TiposContrato.Contains(this))
                {
                    TBL_Admin_Usuarios.TiposContrato.Add(this);
                }
        ...
        private void FixupTBL_Admin_Usuarios1(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TiposContrato1.Contains(this))
            {
                previousValue.TiposContrato1.Remove(this);
            }
    
            if (TBL_Admin_Usuarios1 != null)
            {
                if (!TBL_Admin_Usuarios1.TiposContrato1.Contains(this))
                {
                    TBL_Admin_Usuarios1.TiposContrato1.Add(this);
                }
        ...
        private void FixupContratos(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.TiposContrato, this))
                    {
                        item.TiposContrato = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
