...
{
    public partial class FrmViewLocalizaciones : ViewPage<IFrmViewLocalizacionesPresenter, IFrmViewLocalizacionesView>, IFrmViewLocalizacionesView
    {
        public event EventHandler FilterEvent;

        protected void Page_Load(object sender, EventArgs e)
        {
            ImprimirTituloVentana("Administración Localizaciones");
        }
        ...
        public void GetLocalizaciones(List<Localizaciones> items)
        {
        ...
        {
            var rol = e.Item.DataItem as Localizaciones;
            ...
            if (cmdEditar != null)
            {
                cmdEditar.CommandArgument = rol.IdLocalizacion;
            }
        ...
        {
            Response.Redirect(string.Format("FrmEditLocalizaciones.aspx{0}&TemplateId={1}", GetBaseQueryString(), e.CommandArgument));
        }

        protected void BtnNewClick(object sender, EventArgs e)
        {
            Response.Redirect(string.Format("FrmEditLocalizaciones.aspx{0}", GetBaseQueryString()));
        }
