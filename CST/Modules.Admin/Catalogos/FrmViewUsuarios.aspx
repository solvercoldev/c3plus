<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmViewUsuarios.aspx.cs" Inherits="Modules.Admin.Catalogos.FrmViewUsuarios" %>
<%@ Register TagPrefix="csc" Namespace="ServerControls" Assembly="ServerControls" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

<div style="padding:3px; text-align:right;">
  <asp:button id="btnNew" OnClick="BtnNewClick" runat="server" text="Nuevo Usuario" Visible="true"></asp:button>
</div>
        ...
        <td >
                ...
                <ContentTemplate>
                    ...
                    OnItemDataBound="RptListadoItemDataBound">
	                    ...
	                    <itemtemplate>
		                    <tr>
			                    <td align="left"><%# DataBinder.Eval(Container.DataItem, "CodigoUser")%></td>
                                <td align="left"><%# DataBinder.Eval(Container.DataItem, "Nombres")%></td>
