<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmViewPozos.aspx.cs" Inherits="Modules.Admin.Catalogos.FrmViewPozos" %>
<%@ Register TagPrefix="csc" Namespace="ServerControls" Assembly="ServerControls" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

<div style="padding:3px; text-align:right;">
  <asp:button id="btnNew" OnClick="BtnNewClick" runat="server" text="Nuevo Pozo" Visible="true"></asp:button>
</div>
        ...
        <td >
                ...
                <ContentTemplate>
                    ...
                    OnItemDataBound="RptListadoItemDataBound">
	                    ...
	                    <itemtemplate>
		                    <tr>
			                    <td align="left"><%# DataBinder.Eval(Container.DataItem, "IdPozo")%></td>
