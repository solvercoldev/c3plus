...
namespace Domain.MainModules.Entities
{
    ...
    public partial class Dependencias: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string IdDependencia
        {
            ...
            set
            {
                if (_idDependencia != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'IdDependencia' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupTBL_Admin_Usuarios(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.Dependencias.Contains(this))
            {
            ...
            {
                if (!TBL_Admin_Usuarios.Dependencias.Contains(this))
                {
                    TBL_Admin_Usuarios.Dependencias.Add(this);
                }
        ...
        private void FixupTBL_Admin_Usuarios1(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.Dependencias1.Contains(this))
            {
            ...
            {
                if (!TBL_Admin_Usuarios1.Dependencias1.Contains(this))
                {
                    TBL_Admin_Usuarios1.Dependencias1.Add(this);
                }
        ...
        private void FixupTBL_Admin_Usuarios2(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Dependencias2, this))
                    {
                        item.Dependencias2 = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
