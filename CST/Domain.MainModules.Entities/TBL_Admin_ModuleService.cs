...
namespace Domain.MainModules.Entities
{
    ...
    public partial class TBL_Admin_ModuleService: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int IdModuleServices
        {
            get { return _idModuleServices; }
            set
            {
                if (_idModuleServices != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'IdModuleServices' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _idModuleServices = value;
                    OnPropertyChanged("IdModuleServices");
                }
            }
        }
        private int _idModuleServices;
        ...
        public string servicekey
        {
            ...
            set
            {
                if (_servicekey != value)
                {
                    _servicekey = value;
                    OnPropertyChanged("servicekey");
                }
            }
        }
        ...
        private void FixupTBL_Admin_ModuleType(TBL_Admin_ModuleType previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_Admin_ModuleService.Contains(this))
            {
                previousValue.TBL_Admin_ModuleService.Remove(this);
            }
    
            if (TBL_Admin_ModuleType != null)
            {
                if (!TBL_Admin_ModuleType.TBL_Admin_ModuleService.Contains(this))
                {
                    TBL_Admin_ModuleType.TBL_Admin_ModuleService.Add(this);
                }
