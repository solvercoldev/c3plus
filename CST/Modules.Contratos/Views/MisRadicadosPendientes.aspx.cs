...
{
    public partial class MisRadicadosPendientes : ViewPage<MisRadicadosPendientesPresenter, IMisRadicadosPendientesView>, IMisRadicadosPendientesView
    {
        #region Members
        ...
        {
            ImprimirTituloVentana(string.Format("Mis Radicados Pendientes"));
        }
        ...
        protected void BtnSelectRadicado_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(string.Format("../Admin/FrmAdminRadicadoContrato.aspx?ModuleId={0}&IdContrato={1}&IdRadicado={2}&from=misradpendiente", ModuleId, sIds[0], sIds[1]));
        }
